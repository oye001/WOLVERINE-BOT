...
function systemPrompt(withCa) {
  return (
    ...
    "- ONLY respond to direct questions about $WOLVE, the token, the dev, safety, how to buy, chart, or socials\n" +
    "- If the message is anything else \u2014 hype, casual chat, members talking to each other, reactions, feelings, single words, vague statements \u2014 reply with exactly: IGNORE\n" +
